...
You are working with a dataset of taxi trips. 
You have a tensor, trip_data, where each row is a trip and the columns represent [distance (km), hour_of_day (24h)].

Your goal is to engineer a new binary feature called is_rush_hour_long_trip. 
This feature should be True (or 1) only if a trip meets both of the following criteria:
